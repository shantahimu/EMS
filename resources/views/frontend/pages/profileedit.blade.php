                ...
                <div class="card-body">
                    <div class="card-title mb-4">
                        <div class="d-flex justify-content-start">
                            ...
                            <div class="ml-auto">
                                <input type="button" class="btn btn-primary d-none" id="btnDiscard" value="" />
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="tab-content ml-1" id="myTabContent">
                                <div class="tab-pane fade show active" id="basicInfo" role="tabpanel" aria-labelledby="basicInfo-tab">
                                    ...
                                    <div class="row">
                                        ...
                                        <input name="name" class="col-md-8 col-6" value="{{ auth()->user()->name }}">
                                    </div>
                                    <hr />
                                    ...
                                    <div class="row">
                                        ...
                                        <input name="email" class="col-md-8 col-6" value="{{ auth()->user()->email }}">
